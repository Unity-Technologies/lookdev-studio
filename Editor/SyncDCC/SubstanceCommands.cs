...
{
    public class SubstanceCommands : ICommands
    {
        // TBD
        ...
        public SubstanceCommands(string inHostName, int inPort, int inBufferSize)
        {
            hostName = inHostName;
            port = inPort;
        ...
        public void SendPredesinedMessageToSubstance(CommandType commandType, string[] args)
        {
            /*
        ...
        public string SendMessageToSubstance(string strCmd)
        {
        ...
        public bool IsConnectedSubstance()
        {
            TcpClient tc = null;
        ...
        public bool IsSubstanceRunning()
        {
            /*
        ...
        public void KillSubstanceProcess()
        {
            /*
            System.Diagnostics.Process[] procs = System.Diagnostics.Process.GetProcesses();
