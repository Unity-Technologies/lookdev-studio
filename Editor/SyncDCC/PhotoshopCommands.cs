...
{
    public class PhotoshopCommands : ICommands
    {
        // TBD
        ...
        public PhotoshopCommands(string inHostName, int inPort, int inBufferSize)
        {
            hostName = inHostName;
            port = inPort;
        ...
        public void SendPredesinedMessageToPhotoshop(CommandType commandType, string[] args)
        {
            /*
        ...
        public string SendMessageToPhotoshop(string strCmd)
        {
        ...
        public bool IsConnectedPhotoshop()
        {
            TcpClient tc = null;
