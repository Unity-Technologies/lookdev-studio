...
namespace LookDev.Editor
{
    ...
    public static class SymlinkUtility
    {
        ...
        {
            Symlink(SymlinkType.Junction, null, null, null);
        }
#endif
        ...
        {
            Symlink(SymlinkType.Absolute, null, null, null);
        }
        ...
        {
            Symlink(SymlinkType.Relative, null, null, null);
        }

        public static void Symlink(SymlinkType linkType, string sourceFolderPath, string targetFolderOverride,
            string folderNameOverride)
        {
            ...
            string targetPath = targetFolderOverride;
            if (string.IsNullOrEmpty(targetPath))
                targetPath = uobject != null ? AssetDatabase.GetAssetPath(uobject) : null;
            ...
            targetPath = string.Format("{0}/{1}/{2}", pathToProject, targetPath,
                string.IsNullOrEmpty(folderNameOverride) ? sourceFolderName : folderNameOverride);
